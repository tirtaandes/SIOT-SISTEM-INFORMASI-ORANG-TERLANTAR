...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deskripsi_keperluan = $_POST["deskripsi_keperluan"];
    ...
    if (empty($nomor_surat) || empty($id_orang_terlantar)) {
        ...
        // Siapkan pernyataan SQL untuk menyisipkan data ke dalam tabel SuratKeterangan
        $sql = "INSERT INTO SuratKeterangan (Nomor_Surat, Tanggal_Penerbitan, Deskripsi_Keperluan, ID_OrangTerlantar)
                VALUES ('$nomor_surat', '$tanggal_penerbitan', '$deskripsi_keperluan', '$id_orang_terlantar')";

        // Eksekusi pernyataan SQL
        if ($conn->query($sql) === TRUE) {
            echo "Data surat keterangan berhasil disimpan.";
        } else {
